            ...
            <div class="row mb-2" style="padding: 10px 6px; background-color: #c3cdde">
                <div class="col-sm-6 col-md-3">
                    ...
                    <a href="{{url('dashboard')}}">
                        <span class="fa fa-home" style="font-size: 1.15em"> <h5 class="m-0 text-dark" style="display: inline-block"> Dashboard </h5> </span>
                    </a>
                </div><!-- /.col -->
    ...
    <div class="content-body">
        <div class="container-fluid statistics">
            <div class="row" style="border-bottom: 1px solid #838383; padding: 8px; margin-bottom: 5px">
                <span class="fa fa-user container-fluid">
                ...
                <div class="col-md-3">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Total Student <br> September</h3>
                            <h6> Marked : 000000</h6>
