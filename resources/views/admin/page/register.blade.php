...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ action('DashboardController@index2') }}"><b>Admin</b>LTE</a>
    </div>
    ...
    <div class="card">
        <div class="card-body register-card-body">
            ...
            <form action="{{ action('DashboardController@index3') }}" method="post">
            ...
            <a href="{{ action('PageController@login') }}" class="text-center">I already have a membership</a>
        </div>
        <!-- /.form-box -->
    </div><!-- /.card -->
</div>
