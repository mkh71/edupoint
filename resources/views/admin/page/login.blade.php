...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ action('DashboardController@index3') }}"><b>Admin</b>LTE</a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="{{ action('PageController@login') }}" method="post">
            ...
            <p class="mb-0">
                <a href="{{ action('PageController@register') }}" class="text-center">Register a new membership</a>
            </p>
        </div>
        <!-- /.login-card-body -->
    </div>
